...
public class VertexLabelControl : ContentControl, IVertexLabelControl
{
    ...
    public static readonly StyledProperty<double> AngleProperty =
        AvaloniaProperty.Register<VertexLabelControl, double>(nameof(Angle));
    ...
    public static readonly StyledProperty<Point> LabelPositionProperty =
        AvaloniaProperty.Register<VertexLabelControl, Point>(nameof(LabelPosition));
    ...
    public static readonly StyledProperty<VertexLabelPositionMode> LabelPositionModeProperty =
        AvaloniaProperty.Register<VertexLabelControl, VertexLabelPositionMode>(nameof(LabelPositionMode),
            VertexLabelPositionMode.Sides);
    ...
    public static readonly StyledProperty<VertexLabelPositionSide> LabelPositionSideProperty =
        AvaloniaProperty.Register<VertexLabelControl, VertexLabelPositionSide>(nameof(LabelPositionSide),
            VertexLabelPositionSide.BottomRight);
    ...
    public virtual void UpdatePosition()
    {
        ...
        if (LabelPositionMode == VertexLabelPositionMode.Sides)
        {
            var pt = LabelPositionSide switch
            {
                ...
                VertexLabelPositionSide.Top => new Point(vc.DesiredSize.Width * .5 - DesiredSize.Width * .5,
                    -DesiredSize.Height),
                VertexLabelPositionSide.Bottom => new Point(vc.DesiredSize.Width * .5 - DesiredSize.Width * .5,
                    vc.DesiredSize.Height),
                VertexLabelPositionSide.Left => new Point(-DesiredSize.Width,
                    vc.DesiredSize.Height * .5f - DesiredSize.Height * .5),
                VertexLabelPositionSide.Right => new Point(vc.DesiredSize.Width,
                    vc.DesiredSize.Height * .5f - DesiredSize.Height * .5),
