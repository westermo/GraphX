...
namespace Westermo.GraphX.Logic.Algorithms.LayoutAlgorithms
{
    ...
    public abstract class
        DefaultParameterizedLayoutAlgorithmBase<TVertex, TEdge, TGraph, TParam> : ParameterizedLayoutAlgorithmBase<
        TVertex,
        TEdge, TGraph, TParam>
        where TVertex : class
        where TEdge : IEdge<TVertex>
        ...
        where TParam : class, ILayoutParameters, new()
    {
        ...
        protected DefaultParameterizedLayoutAlgorithmBase(TGraph visitedGraph,
            IDictionary<TVertex, Point> vertexPositions, TParam oldParameters)
            : base(visitedGraph, vertexPositions, oldParameters)
        {
        }
    ...
    public abstract class
        ParameterizedLayoutAlgorithmBase<TVertex, TEdge, TGraph, TParam> : LayoutAlgorithmBase<TVertex, TEdge, TGraph>,
        ...
        where TParam : class, ILayoutParameters
    {
        ...
        /// <summary>
        /// Ensures that all positions generated by InitializeWithRandomPositions() method will be unique.
        /// Can lead to excessive CPU usage for large amount of vertices. Default value is False. True for LinLog.
        /// </summary>
        protected bool EnsureUniqueRandomInitialPositions { get; set; }
            ...
            double translate_y)
        {
            ...
            foreach (var v in VisitedGraph.Vertices)
            {
                ...
                if (VertexPositions.ContainsKey(v)) continue;
